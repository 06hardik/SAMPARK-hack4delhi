...
// 5 MCD Delhi Parking Lots with full addresses and coordinates
...
// Historical Violations for MCD lots (no grace period - immediate violations)
export const violations: Violation[] = [
  // Active violations
  {
    id: 'viol-001',
    lotId: 'lot-002',
    lotName: 'MCD Car Parking — Qulab Colony, GB Road, Nabi Karim, Paharganj, Delhi',
    contractor: 'MCD',
  ...
  },
  {
    id: 'viol-002',
    lotId: 'lot-004',
    lotName: 'MCD Parking — Padam Singh Road, Near Siam International Hotel, West Extension Area, Karol Bagh, Delhi',
    contractor: 'MCD',
  ...
  // Resolved violations
  {
    id: 'viol-003',
    lotId: 'lot-001',
    lotName: 'MCD Parking — Asaf Ali Road, Near Delhi Police Help Center, Turkman Gate, Delhi',
    contractor: 'MCD',
  ...
  },
  {
    id: 'viol-005',
    lotId: 'lot-003',
    lotName: 'MCD Scooter Parking — Qutub Road Market, Dangarmal Surana Marg, Narain, Delhi',
    contractor: 'MCD',
    startedAt: daysAgo(2),
  ...
  },
  {
    id: 'viol-007',
    lotId: 'lot-005',
    lotName: 'MCD Authorized Lot Parking — State Bank of India, Edayazham, New Delhi',
    contractor: 'MCD',
    startedAt: daysAgo(5),
...
// Violation summary data (all MCD lots combined)
export const chronicOffenders: ChronicOffender[] = [
  {
    contractor: 'MCD Delhi',
    totalViolations: 8,
...
export const scenarioConfigs: SimulationScenarioConfig[] = [
  {
    id: 'rush_hour',
    name: 'Rush Hour',
    description: 'Simulates 8-9am and 5-6pm traffic patterns with high volume, pushes multiple lots over capacity immediately',
    icon: '🚗',
  },
];

// Helper function to get lot with computed status (no grace period - immediate violation)
